...
_lr_productions = [
  ...
  ('column_definitions -> column_definition','column_definitions',1,'p_column_definitions','sql_parser.py',43),
  ('column_definitions -> column_definitions COMMA column_definition','column_definitions',3,'p_column_definitions','sql_parser.py',44),
  ('column_definition -> ID data_type','column_definition',2,'p_column_definition','sql_parser.py',51),
  ('data_type -> INT','data_type',1,'p_data_type','sql_parser.py',55),
  ('data_type -> CHAR','data_type',1,'p_data_type','sql_parser.py',56),
  ('data_type -> DECIMAL','data_type',1,'p_data_type','sql_parser.py',57),
  ('select_statement -> SELECT select_list FROM ID','select_statement',4,'p_select_statement','sql_parser.py',62),
  ('select_statement -> SELECT select_list FROM ID HAVING condition','select_statement',6,'p_select_statement','sql_parser.py',63),
  ('select_list -> ID','select_list',1,'p_select_list','sql_parser.py',70),
  ('select_list -> function','select_list',1,'p_select_list','sql_parser.py',71),
  ('select_list -> select_list COMMA ID','select_list',3,'p_select_list','sql_parser.py',72),
  ('select_list -> select_list COMMA function','select_list',3,'p_select_list','sql_parser.py',73),
  ('function -> SUM LPAREN ID RPAREN','function',4,'p_function','sql_parser.py',80),
  ('function -> COUNT LPAREN ID RPAREN','function',4,'p_function','sql_parser.py',81),
  ('function -> MIN LPAREN ID RPAREN','function',4,'p_function','sql_parser.py',82),
  ('condition -> condition_term','condition',1,'p_condition','sql_parser.py',88),
  ('condition -> condition OR condition_term','condition',3,'p_condition','sql_parser.py',89),
  ('condition_term -> condition_factor','condition_term',1,'p_condition_term','sql_parser.py',97),
  ('condition_term -> condition_term AND condition_factor','condition_term',3,'p_condition_term','sql_parser.py',98),
  ('condition_factor -> expression EQ expression','condition_factor',3,'p_condition_factor','sql_parser.py',106),
  ('condition_factor -> expression LT expression','condition_factor',3,'p_condition_factor','sql_parser.py',107),
  ('condition_factor -> expression LE expression','condition_factor',3,'p_condition_factor','sql_parser.py',108),
  ('condition_factor -> expression GT expression','condition_factor',3,'p_condition_factor','sql_parser.py',109),
  ('condition_factor -> expression GE expression','condition_factor',3,'p_condition_factor','sql_parser.py',110),
  ('condition_factor -> expression NE expression','condition_factor',3,'p_condition_factor','sql_parser.py',111),
  ('expression -> term','expression',1,'p_expression','sql_parser.py',118),
  ('expression -> expression PLUS term','expression',3,'p_expression','sql_parser.py',119),
  ('expression -> expression MINUS term','expression',3,'p_expression','sql_parser.py',120),
  ('term -> factor','term',1,'p_term','sql_parser.py',128),
  ('term -> term TIMES factor','term',3,'p_term','sql_parser.py',129),
  ('term -> term DIVIDE factor','term',3,'p_term','sql_parser.py',130),
  ('factor -> ID','factor',1,'p_factor','sql_parser.py',138),
  ('factor -> NUMBER','factor',1,'p_factor','sql_parser.py',139),
  ('factor -> function','factor',1,'p_factor','sql_parser.py',140),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','sql_parser.py',141),
]
